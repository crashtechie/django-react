...
class CustomerViewSetTest(APITestCase):
    ...
    def test_update_customer(self):
        ...
        response = self.client.put(
            self.detail_url(self.customer1.pk), update_data, format="json"
        )
    ...
    def test_partial_update_customer(self):
        ...
        partial_data = {"phone": "555-9999"}

        response = self.client.patch(
            self.detail_url(self.customer1.pk), partial_data, format="json"
        )
    ...
    def test_deactivate_customer_action(self):
        ...
        deactivate_url = reverse(
            "customer-deactivate", kwargs={"pk": self.customer1.pk}
        )
