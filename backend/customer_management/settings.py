...
SECRET_KEY = config.get('secret_key', os.getenv('SECRET_KEY', 'django-insecure-dev-key-change-in-production'))

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config.get('debug', os.getenv('DEBUG', 'True').lower() == 'true')

ALLOWED_HOSTS = config.get('allowed_hosts', os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(','))
...
# CORS settings
CORS_ALLOWED_ORIGINS = config.get('cors', {}).get('allowed_origins', [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost",
    "http://127.0.0.1",
